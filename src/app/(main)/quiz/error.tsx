...
export default function QuizError({ error, reset }: ErrorProps) {
  useEffect(() => { console.error('[QuizError boundary]', error.message); }, [error]);
  return (
    <div role="alert" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '16px', padding: '3rem 2rem', textAlign: 'center', minHeight: '300px' }}>
      ...
      <div>
        <h2 style={{ fontSize: '18px', fontWeight: 700, color: 'var(--color-text)', marginBottom: '6px' }}>Failed to load quiz</h2>
