    ...
    try {
      ...
      if (error) {
        ...
        if (error.message === 'Email not confirmed') {
          toast.error(
            lang === 'ja'
              ? 'メールアドレスが確認されていません。メールを確認するか、管理者にお問い合わせください。'
      ...
      toast.success(lang === 'ja' ? 'ログインしました！' : 'Signed in successfully!');
  ...
  return (
    <div
      style={{
        ...
        backgroundImage: `radial-gradient(circle at 15% 30%, rgba(233, 69, 96, 0.06) 0%, transparent 45%), radial-gradient(circle at 85% 70%, rgba(245, 166, 35, 0.05) 0%, transparent 45%)`,
        display: 'flex',
      ...
      <div ref={containerRef} style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div className="auth-brand" style={{ textAlign: 'center', marginBottom: '1.75rem' }}>
          ...
          <p style={{ fontSize: '14px', color: 'var(--color-muted)', lineHeight: 1.5 }}>
            {lang === 'ja' ? 'ようこそ！学習を続けましょう。' : 'Welcome back! Continue your journey.'}
          </p>
        </div>
        ...
        <div className="auth-card bento-tile" style={{ padding: '2rem' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              ...
              <input
                ...
                style={{
                  ...
                  padding: '10px 14px',
                  borderRadius: '8px',
                  border: `1px solid ${errors.email ? 'var(--color-destructive)' : 'var(--color-border)'}`,
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
              ...
              <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                <input
                  ...
                  style={{
                    ...
                    borderRadius: '8px',
                    border: `1px solid ${errors.password ? 'var(--color-destructive)' : 'var(--color-border)'}`,
                    background: 'var(--color-surface)',
                    fontSize: '14px',
                    color: 'var(--color-text)',
                    outline: 'none',
              ...
              {errors.password && (
                <span role="alert" style={{ fontSize: '12px', color: 'var(--color-destructive)' }}>
                  {lang === 'ja' ? 'パスワードは6文字以上必要です' : 'Password must be at least 6 characters'}
                </span>
              )}
            </div>
          ...
          <button
            ...
            style={{
              ...
              fontWeight: 600,
              color: 'var(--color-text)',
              transition: 'background-color 0.15s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.15s ease',
              boxSizing: 'border-box',
            }}
          >
        ...
        >
          <span>{lang === 'ja' ? 'アカウントをお持ちでないですか？ ' : "Don't have an account? "}</span>
          <Link
            href="/auth/register"
